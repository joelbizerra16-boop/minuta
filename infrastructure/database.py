...
def ensure_database_directories(database_url: str, data_root: Path | None = None, pdf_storage_dir: Path | None = None) -> None:
...
def configure_database(
    *,
    ...
    global _engine, _session_factory, _data_root, _pdf_storage_dir

    _data_root = data_root
    _pdf_storage_dir = pdf_storage_dir
    ensure_database_directories(database_url, data_root=data_root, pdf_storage_dir=pdf_storage_dir)
